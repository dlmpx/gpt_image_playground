...
import { useStore, getCachedImage, ensureImageCached, reuseConfig, editOutputs, removeTask, showCodexCliPrompt, getCodexCliPromptKey, retryTask, addWorkflowCandidateFromTask, promoteCandidateToStage, createWorkflowRun, backtrackCandidate, updateCandidateNotes, rateTask, trashTask, restoreTask } from '../store'
      ...
      >
        ...
        <div className="md:w-1/2 w-full p-5 overflow-y-auto overscroll-contain flex flex-col">
          ...
          <div className="grid grid-cols-5 sm:flex gap-2 pt-4 border-t border-gray-100 dark:border-white/[0.08]">
            ...
            <div className="col-span-1 sm:flex-none sm:w-auto w-full flex items-center justify-center rounded-xl bg-gray-50 dark:bg-white/[0.04] px-2 gap-1.5">
              <StarRating
